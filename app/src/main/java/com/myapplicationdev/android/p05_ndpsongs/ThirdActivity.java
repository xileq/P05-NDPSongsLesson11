...
//        rg = (RadioGroup) findViewById(R.id.rgStars);
        ...
        rate3act=(RatingBar)findViewById(R.id.rate2);
        ...
        rate3act.setRating(currentSong.getStars());
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //  RadioButton rb = (RadioButton) findViewById(selectedRB);
               currentSong.setStars((int)rate3act.getRating());
...
//        int stars = (int) rate3act.getRating();
//        return stars;
//    }
}